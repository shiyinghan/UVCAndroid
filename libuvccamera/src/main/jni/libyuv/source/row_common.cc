...
void ABGRToRGB565Row_C(const uint8_t* src_abgr, uint8_t* dst_rgb, int width) {
  int x;
  for (x = 0; x < width - 1; x += 2) {
    uint8_t b0 = src_abgr[2] >> 3;
    uint8_t g0 = src_abgr[1] >> 2;
    uint8_t r0 = src_abgr[0] >> 3;
    uint8_t b1 = src_abgr[6] >> 3;
    uint8_t g1 = src_abgr[5] >> 2;
    uint8_t r1 = src_abgr[4] >> 3;
  ...
  if (width & 1) {
    uint8_t b0 = src_abgr[0] >> 3;
    uint8_t g0 = src_abgr[1] >> 2;
    uint8_t r0 = src_abgr[2] >> 3;
