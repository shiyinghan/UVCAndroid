...
// Convert from YUV to 2.14 fixed point BGR
#define YUVTOBGR                                          \
  "umull2     v3.4s, v0.8h, v24.8h           \n"          \
  "umull      v6.8h, v1.8b, v30.8b           \n"          \
  "umull      v0.4s, v0.4h, v24.4h           \n"          \
  ...
  "umull2     v5.8h, v1.16b, v29.16b         \n" /* DR */ \
  "add        v17.8h, v0.8h, v26.8h          \n" /* G */  \
  "add        v18.8h, v0.8h, v4.8h           \n" /* B */  \
  "add        v16.8h, v0.8h, v5.8h           \n" /* R */  \
  "uqsub      v17.8h, v17.8h, v6.8h          \n" /* G */  \
  "uqsub      v18.8h, v18.8h, v25.8h         \n" /* B */  \
  "uqsub      v16.8h, v16.8h, v27.8h         \n" /* R */
...
void YUY2ToABGRRow_NEON(const uint8_t* src_yuy2,
    ...
    "movi        v19.8b, #255                  \n"
    "ldr         q2, [%[kNV12Table]]           \n"
    "1:                                        \n" READYUY2 YUVTOBGR BGRTOBGR8
    "subs        %w[width], %w[width], #8      \n"
    "st4         {v16.8b,v17.8b,v18.8b,v19.8b}, [%[dst_abgr]], #32 \n"
    "b.gt        1b                            \n"
    : [src_yuy2] "+r"(src_yuy2),                          // %[src_yuy2]
