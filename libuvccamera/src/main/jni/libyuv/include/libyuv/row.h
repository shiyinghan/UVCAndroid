...
#define HAS_ABGRTORGB24ROW_NEON
#define HAS_ARGBTORGB24ROW_NEON
#define HAS_ARGBTORGB565DITHERROW_NEON
#define HAS_ARGBTORGB565ROW_NEON
#define HAS_ABGRTORGB565ROW_NEON
...
void UYVYToARGBRow_NEON(const uint8_t* src_uyvy,
                        ...
                        const struct YuvConstants* yuvconstants,
                        int width);
void YUY2ToABGRRow_NEON(const uint8_t* src_yuy2,
                        uint8_t* dst_argb,
                        const struct YuvConstants* yuvconstants,
                        int width);
...
void ABGRToRGB565Row_NEON(const uint8_t* src_abgr,
                          uint8_t* dst_rgb565,
                          int width);
...
void ABGRToRGB565Row_C(const uint8_t* src_argb, uint8_t* dst_rgb, int width);
...
void UYVYToARGBRow_C(const uint8_t* src_uyvy,
                     ...
                     const struct YuvConstants* yuvconstants,
                     int width);
void YUY2ToABGRRow_C(const uint8_t* src_yuy2,
                     uint8_t* rgb_buf,
                     const struct YuvConstants* yuvconstants,
                     int width);
...
void ABGRToRGB565Row_Any_NEON(const uint8_t* src_ptr,
                              uint8_t* dst_ptr,
                              int width);
...
void UYVYToARGBRow_Any_NEON(const uint8_t* src_ptr,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void YUY2ToABGRRow_Any_NEON(const uint8_t* src_ptr,
                            uint8_t* dst_ptr,
                            const struct YuvConstants* yuvconstants,
                            int width);
