...
public class HandlerThreadHandler extends Handler {
    ...
    public static HandlerThreadHandler createHandler(final Callback callback) {
    ...
    public static HandlerThreadHandler createHandler(final String name, final Callback callback) {
        final HandlerThread thread = new HandlerThread(name, Process.THREAD_PRIORITY_MORE_FAVORABLE);
        thread.start();
